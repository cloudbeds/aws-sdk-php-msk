...
class S3Client extends AwsClient implements S3ClientInterface
{
    ...
    public function createPresignedRequest(CommandInterface $command, $expires, array $options = [])
    {
        ...
        /** @var \CloudBeds\Aws\MskFork\Signature\SignatureInterface $signer */
     ...
     * use the {@see \CloudBeds\Aws\MskFork\S3\S3Client::createPresignedRequest} method and get
    ...
    public function getObjectUrl($bucket, $key)
    {
        ...
        return (string) \CloudBeds\Aws\MskFork\serialize($command)->getUri();
    }
