...
interface AwsClientInterface
{
     ...
     * {@see \CloudBeds\Aws\MskFork\Credentials\CredentialsInterface} object.
     *
     ...
     *
     * @return \CloudBeds\Aws\MskFork\Api\Service
     */
     ...
     *
     * @return \CloudBeds\Aws\MskFork\ResultPaginator
     * @throws \UnexpectedValueException if the iterator config is invalid.
     */
     ...
     *                              can be provided in an associative array in
     *                              the @waiter key.
     * @return \CloudBeds\Aws\MskFork\Waiter
     * @throws \UnexpectedValueException if the waiter is invalid.
     */
