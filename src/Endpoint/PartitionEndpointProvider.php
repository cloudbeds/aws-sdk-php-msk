...
class PartitionEndpointProvider
{
    ...
    {
        $data = \CloudBeds\Aws\MskFork\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \CloudBeds\Aws\MskFork\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
