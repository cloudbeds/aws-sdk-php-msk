 ...
 * @method \CloudBeds\Aws\MskFork\Result addApplicationVpcConfiguration(array $args = [])
 ...
 * @method \CloudBeds\Aws\MskFork\Result createApplicationPresignedUrl(array $args = [])
 * @method \GuzzleHttp\Promise\Promise createApplicationPresignedUrlAsync(array $args = [])
 * @method \CloudBeds\Aws\MskFork\Result createApplicationSnapshot(array $args = [])
 ...
 * @method \CloudBeds\Aws\MskFork\Result deleteApplicationSnapshot(array $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteApplicationSnapshotAsync(array $args = [])
 * @method \CloudBeds\Aws\MskFork\Result deleteApplicationVpcConfiguration(array $args = [])
 ...
 * @method \CloudBeds\Aws\MskFork\Result describeApplicationSnapshot(array $args = [])
 * @method \GuzzleHttp\Promise\Promise describeApplicationSnapshotAsync(array $args = [])
 * @method \CloudBeds\Aws\MskFork\Result describeApplicationVersion(array $args = [])
 ...
 * @method \CloudBeds\Aws\MskFork\Result listApplicationSnapshots(array $args = [])
 ...
 * @method \CloudBeds\Aws\MskFork\Result rollbackApplication(array $args = [])
 ...
 * @method \CloudBeds\Aws\MskFork\Result updateApplicationMaintenanceConfiguration(array $args = [])
